...
@ctypes_function("llama_sampler_init_tail_free", [ctypes.c_float, ctypes.c_size_t], llama_sampler_p_ctypes)
...
def llama_perf_dump_yaml(stream: ctypes.POINTER(ctypes.c_void_p), ctx: llama_context_p, /):
    ...
