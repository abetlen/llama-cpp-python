...
def build_completion_v1_completions_post_request(
    **kwargs: Any,
...
def build_embedding_v1_embeddings_post_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_chat_completion_v1_chat_completions_post_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
