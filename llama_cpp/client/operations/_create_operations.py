...
def build_completion_v1_completions_post_request(**kwargs: Any) -> HttpRequest:
...
def build_embedding_v1_embeddings_post_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_chat_completion_v1_chat_completions_post_request(
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class CreateOperations:
    ...
    @overload
    def completion_v1_completions_post(
        self,
    ...
    @overload
    def embedding_v1_embeddings_post(
        self,
